...
original text is in Sec "Color operators-old" ***}
...
\ref{fig:color_derivatives}. To characterize 3-BMGs at least two of the three
color derivatives must satisfied a particular condition as provided in 
}
\begin{definition}
\mh{
