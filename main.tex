...
Let $(\Gamma,\sigma)$ be a n-colored digraph with colors red, blue, yellow, and color sets $R,B,Y$ respectively.
\TODO{confused now, are $R,B,Y$ really "colors" sets or "vertex" sets? and if not sets, a unified notion for colors must be used, either all
