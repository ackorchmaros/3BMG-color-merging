...
}} \ak{Suppose $\partial_i(\Gamma,\sigma)$ is a 2-BMG explained by $(T_i,\sigma_i)$,  $\Delta_{ij}(\partial_i(\Gamma,\sigma))$ denotes the
...
tree explaining anything.  just the edges and certain colors -- why do I need them now ??? }
