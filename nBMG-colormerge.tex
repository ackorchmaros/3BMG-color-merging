...
\begin{proof}
   ...
   \ref{prop:BMG-triple-charac} implies that $(G_\Pi,\sigma_\Pi)$ is a BMG. 
    ...
    ,\mathscr{F}(G_\Pi,\sigma_\Pi) )$ is consistent \ak{Why?}. By the same arguments as
    used in the first case, $(G_\Pi,\sigma_\Pi)$ is a BMG. \ak{For the case of $3$ colors and $\Pi=\{\{1\},\{2,3\}\}$, Fig.1 in main.tex gives a counterexample. 
...
\TODO{\smallskip
\begin{itemize}
	\item  main question (1) When is a $(G_{\Pi},\sigma_{\Pi})$ a 2-BMG?
